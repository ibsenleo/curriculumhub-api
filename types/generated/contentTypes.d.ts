...
export interface ApiEducationEducation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    resumee: Schema.Attribute.Relation<'manyToOne', 'api::resumee.resumee'>;
    start_year: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiExpertiseItemExpertiseItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::expertise-item.expertise-item'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiExpertiseExpertise extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    expertise_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::expertise-item.expertise-item'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
